...
An implementation of EfficienNet that covers variety of related models.bak with efficient architectures:
...
The majority of the above models.bak (EfficientNet*, MixNet, MnasNet) and original weights were made available
by Mingxing Tan, Quoc Le, and other members of their Google Brain team. Thanks for consistently releasing
the models.bak and weights open source!
...
class EfficientNetFeatures(nn.Module):
    ...
    and object detection models.bak.
    """
