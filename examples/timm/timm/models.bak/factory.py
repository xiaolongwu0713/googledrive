...
def create_model(
    ...
    Args:
        ...
        scriptable (bool): set layer config so that model is jit scriptable (not working for all models.bak yet)
    ...
    # Only EfficientNet and MobileNetV3 models.bak have support for batchnorm params or drop_connect_rate passed as args
    ...
    # Parameters that aren't supported by all models.bak or are intended to only override model defaults if set
    # should default to None in command line args/cfg. Remove them if they are present and not set so that
    # non-supporting models.bak don't break and default args remain in effect.
