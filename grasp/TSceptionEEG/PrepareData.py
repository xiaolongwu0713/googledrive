...
class Processer:
    ...
    def load_data(self, path, subject):
        ...
        self.data = np.stack(data_list, axis = 0) # (2, 6, 4, 15360) (subjs, trials, channels, time)
        self.label = np.stack(label_list, axis = 0) # (2, 6, 15360) (subjs, trial, time)
    ...
    def format_data(self):
        ...
        self.data_processed = np.expand_dims(data, axis = 2) # (2, 6, 1, 4, 15360)

        self.label_processed = label # (2, 6, 15360)
    ...
    def split_data(self, segment_length = 1, overlap = 0, sampling_rate = 256, save = True):
        ...
        self.data_processed = data_split_array # (2, 6, 574, 1, 4, 1024): (subj, trials, windNum, freq, channel, windSize)
        self.label_processed = label_split_array # (2, 6, 574): (subj, trials, windNum)
        ...
        if save == True:
            if self.data_processed.all() != None:
              ...
              save_path = '/Users/long/Documents/BCI/python_scripts/grasp/TSceptionEEG/data'
              filename_data = save_path / Path('data/data_split.hdf')
...
if __name__ == "__main__":
    ...
    Pro.load_data(path='/Users/long/Documents/BCI/python_scripts/grasp/TSceptionEEG/data', subject=2)
    Pro.format_data()      
