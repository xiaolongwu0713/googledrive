...
default_cfgs = {
    # hybrid in-1k models.bak (weights from official JAX impl where they exist)
    ...
    # hybrid in-21k models.bak (weights from official Google JAX impl where they exist)
    ...
    # hybrid models.bak (using timm resnet backbones)
...
def _create_vision_transformer_hybrid(variant, backbone, pretrained=False, **kwargs):
    ...
    kwargs.setdefault('patch_size', 1)  # default patch size for hybrid models.bak if not set
