...
data_dir='/Volumes/Samsung_T5/data/braindecode/'
...
for i in range(5):
	...
	filename = data_dir + "train/" + str(i+1) + ".mat"
	savenamedata =data_dir + "train/" + str(i+1) + "traindata.npy"
	savenamelabel =data_dir + "train/"+ str(i+1) + "trainlabel.npy"
...
for i in range(5):
	...
	filename = data_dir + "test/" + str(i+1) + ".mat"
	savenamedata = data_dir +"test/" + str(i+1) + "testdata.npy"
	savenamelabel = data_dir +"test/"+ str(i+1) + "testlabel.npy"
	X,y = load_bbci_data(filename, low_cut_hz)
	np.save(savenamedata,X)
	np.save(savenamelabel,y)
