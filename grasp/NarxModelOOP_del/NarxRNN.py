...
from grasp.NarxModelOOP.model import DA_RNN


lr=0.001
epochs=50
T=20
hiddenSize_encoder = 150
hiddenSize_decoder = 150
...
for epoch in range(epochs):
    ...
    if epoch % 5 ==0:
        ...
        figname = '/Users/long/BCI/python_scripts/grasp/NarxModelOOP/result/prediction' + str(epoch) + '.pdf'
        fig.savefig(figname)
        plt.close(fig)
