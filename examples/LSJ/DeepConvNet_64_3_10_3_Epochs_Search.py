from EEGModels import DeepConvNet_210519_512_10, DeepConvNet_210519_512_10_res
import numpy as np
...
for subj in range( subjNum ):
    ...
    loadPath = '/Volumes/Samsung_T5/data/gesture/preprocessing_tf/P10/preprocessingALL_3_Algorithm_v3.mat'
    ...
    for ex in range(repeatTs):
        ...
        for i, j in tkFold.split(Inx, tampLbl):
            ...
            #model = DeepConvNet_210519_512_10_res(classNum, Chans=channel, Samples=sample,dropoutRate=0.5)
...
varsName = 'D:/lsj/Modelvari_CNN/DeepConvNet_512_10_res_epochSearch_1.mat'
savemat(varsName, {'accuracy': accuracy, 'loss': loss})
