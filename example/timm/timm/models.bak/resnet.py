...
default_cfgs = {
    ...
    #  ResNeXt models.bak - Weakly Supervised Pretraining on Instagram Hashtags
    ...
    #  Semi-Supervised ResNe*t models.bak from https://github.com/facebookresearch/semi-supervised-ImageNet1K-models
    #  Please note the CC-BY-NC 4.0 license on theses weights, non-commercial use only.
    'ssl_resnet18':  _cfg(
    ...
    #  Semi-Weakly Supervised ResNe*t models.bak from https://github.com/facebookresearch/semi-supervised-ImageNet1K-models
    #  Please note the CC-BY-NC 4.0 license on theses weights, non-commercial use only.
    'swsl_resnet18': _cfg(
    ...
    #  Squeeze-Excitation ResNets, to eventually replace the models.bak in senet.py
    'seresnet18': _cfg(
        url='',
        interpolation='bicubic'),
    'seresnet34': _cfg(
    ...
    #  Squeeze-Excitation ResNeXts, to eventually replace the models.bak in senet.py
...
class ResNet(nn.Module):
    ...
    ResNet variants (the same modifications can be used in SE/ResNeXt models.bak as well):
