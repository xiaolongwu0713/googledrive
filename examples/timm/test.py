...
model = timm.create_model('visformer_tiny',num_classes=5,in_chans=3,img_size=[496,500],batch_size=10) # or visformer_small
...
registry.model_entrypoint('visformer_tiny') # locate the definition
