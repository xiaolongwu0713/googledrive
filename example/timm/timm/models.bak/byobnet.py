...
In all cases the models.bak have been modified to fit within the design of ByobNet. I've remapped
...
the same as original residual blocks in ResNe(X)t, DarkNet, and other existing models.bak. Note also some
...
model_cfgs = dict(
    ...
    # A series of ResNeXt-26 models.bak w/ one of none, GC, SE, ECA, BAT attn, group size 32, SiLU act,
    ...
    # ResNet-32 (2, 3, 3, 2) models.bak w/ no attn, no groups, SiLU act, no pre-fc feat layer, tiered stem w/o maxpool
    ...
    # ResNet-33 (2, 3, 3, 2) models.bak w/ no attn, no groups, SiLU act, 1280 pre-FC feat, tiered stem w/o maxpool
    ...
    # A series of ResNet-33 (2, 3, 3, 2) models.bak w/ one of GC, SE, ECA attn, no groups, SiLU act, 1280 pre-FC feat
...
class DarkBlock(nn.Module):
    ...
    The GE-Net impl included a 1x1 + 3x3 block in their search space. It was not used in the feature models.bak.
