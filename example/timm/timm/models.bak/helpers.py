...
def adapt_input_conv(in_chans, conv_weight):
    ...
    if in_chans == 1:
        if I > 3:
            ...
            # For models.bak with space2depth stems
...
def update_default_cfg_and_kwargs(default_cfg, kwargs, kwargs_filter):
    ...
    # Filter keyword args for task specific model variants (some 'features only' models.bak, etc.)
...
def build_model_with_cfg(
    ...
    This helper fn aids in the construction of a model including:
      ...
      * passing through optional model_cfg for models.bak with config based arch spec
    ...
    # For classification models.bak, check class attr, then kwargs, then default to 1k, otherwise 0 for feats
