...
class TemporalFusionTransformer(pl.LightningModule):
    def __init__(self, hparams,train_dataset,test_dataset,valid_dataset):
    ...
    def train_dataloader(self):
        # REQUIRED
        return DataLoader(self.train_dataset, batch_size=self.minibatch_size, shuffle=False, drop_last=True, num_workers=1)

    def val_dataloader(self):
        # OPTIONAL
        return DataLoader(self.valid_dataset, batch_size=self.minibatch_size, shuffle=False, drop_last=True, num_workers=1)

    def test_dataloader(self):
        # OPTIONAL
        return DataLoader(self.test_dataset, batch_size=self.minibatch_size, shuffle=False, drop_last=True, num_workers=1)