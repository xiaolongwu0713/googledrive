...
been included here as pretrained models.bak from their original .NPZ checkpoints.
...
def create_resnetv2_stem(
    ...
    if is_stem_deep(stem_type):
        # A 3 deep 3x3  conv stack as in ResNet V1D models.bak
    ...
    if 'fixed' in stem_type:
        # 'fixed' SAME padding approximation that is used in BiT models.bak
